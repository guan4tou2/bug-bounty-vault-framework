...
These prompts are public-safe workflow roles. They provide structure for authorized work without carrying target data, exploit payloads, private lessons, or operational secrets.

Use them as source material for private agents, local skills, or manual checklists.
...
Private projects can extend these prompts with local tools and program rules. Public forks should keep them generic.
