...
description: Use when asked to use project Claude agents, attack-chain-deep-dive, bbflow-runner, pre-recon, report-writer, vault-sync, or to mirror bug bounty agent behavior in Gemini CLI.
---
